...
def breadthFirstSearch(problem):
    ...
    # Use a Queue, so the search explores all nodes on one level before to the next level
    fringe = util.Queue()
...
def uniformCostSearch(problem):
    ...
    # Use a PriorityQueue, the cost of actions is calculated with a provided heuristic
    ...
    # Place the starting point on the priority queue
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    # Use a priority queue, the cost of actions is calculated with a provided heuristic
    fringe = util.PriorityQueue()
